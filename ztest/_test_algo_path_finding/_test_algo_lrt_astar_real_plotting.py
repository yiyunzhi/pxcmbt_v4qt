...
# ------------------------------------------------------------------------------
# Project       : 
# Sourcefile(s) : _test_algo_astar_real_plotting.py
# ------------------------------------------------------------------------------
#
# File          : _test_algo_astar_real_plotting.py
#
...
from ztest._test_pathfind_dstar_lite_real_plotted import Env,Plotting
...
def main():
    ...
    lrta = LrtAStarN(s_start, s_goal, 250, "manhattan")
