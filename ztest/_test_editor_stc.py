...
# ------------------------------------------------------------------------------
# Project       : 
# Sourcefile(s) : _test_editor_stc.py
# ------------------------------------------------------------------------------
#
# File          : _test_editor_stc.py
#
...
# ------------------------------------------------------------------------------
import sys,os
from core.gui.editor.blocks import STCNodeGraph
#from gui.qtnode_graph.nodes.class_base_node import BaseNode
#from gui.qtnode_graph.nodes.class_group_node import GroupNode
#from gui.qtnode_graph.widgets.class_minimap_view import MiniMapGraphicsView
