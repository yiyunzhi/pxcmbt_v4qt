...
UI_FILE = os.path.join(os.path.dirname(__file__), '_test_qtads_cw_mainwindow.ui')
MainWindowUI, MainWindowBase = QtUiTools.loadUiType(UI_FILE)
...
class MainWindow(MainWindowUI, MainWindowBase):
    ...
    def __init__(self, parent=None):
        ...
        self.dock_manager = QtAds.CDockManager(self,inherit_style=False)
        ...
        central_dock_area.setAllowedAreas(QtAds.EnumDockWidgetArea.OUTER_DOCK_AREAS)
